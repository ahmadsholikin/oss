    ...
    <body>
        <div class="sidebar">
            <div class="sidebar-header">
                <div>
                    <a class="navbar-brand brand-logo" href="<?= base_url(); ?>/beranda"><img  style="height:45px;width: auto;padding:3px 0px" src="<?=base_url();?>/writable/uploads/<?=$_SESSION['logo'];?>" alt="logo" /></a>
